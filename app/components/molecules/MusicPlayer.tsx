...
export const MusicPlayer: React.FC<MusicPlayerProps> = ({
	...
	return (
		<div className="bg-white rounded-2xl shadow-lg p-4 max-h-48 overflow-hidden border border-gray-200">
			...
			<div className="flex items-center space-x-4 mb-4">
				...
				<div className="flex-1 min-w-0">
					<Text as="p" size="sm" weight="medium" truncate className="text-gray-800 mb-1">
						{songTitle}
					</Text>
